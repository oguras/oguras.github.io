(function() {
    ...
    assessmentButton.onclick = () => {
        ...
        if (userName.length === 0) { // 名前が空の時処理を終了する
            return;
        }
    ...
    const answers = [
            ...
            '{userName}のいいところは思いやりです。気にかけてもらった多くの人が感謝しています。',
            '{userName}のいいところは感受性です。{userName}が感じたこと皆が共感し、わかりあうことができます。',
            '{userName}のいいところは節度です。強引すぎない{userName}の考えに皆が感謝しています。',
            '{userName}のいいところは好奇心です。新しいことに向かっていく{userName}の心構えが多くの人に魅力的に映ります。',
            '{userName}のいいところは気配りです。{userName}の配慮が多くの人を救っています。',
            '{userName}のいいところはその全てです。ありのままの{userName}自身がいいところなのです。',
            '{userName}のいいところは自制心です。やばいと思ったときにしっかりと衝動を抑えられるというところが皆から評価されています。'
    ];
    ...
    function assessment(userName) {
        ...
        //文字のコード番号の合計を回答の回数で割って添字の数値を求める
